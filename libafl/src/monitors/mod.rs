...
use crate::monitors::stats::{ClientStatsManager,EdgeCoverage};
    ...
    F: FnMut(&str),
{
    fn display(
        ...
        let edges_stats = client_stats_manager.edges_coverage().map_or(
            "0%".to_string(),
            |EdgeCoverage {
                 edges_hit,
                 edges_total,
        ...
        let (edges_hit, edges_count) = client_stats_manager
        .edges_coverage()
        .map_or((0, 0), |EdgeCoverage { edges_hit, edges_total }| (edges_hit, edges_total));
        let global_stats = client_stats_manager.global_stats();
        let mut fmt = format!(
            "[{} #{}] run time: {}, clients: {}, corpus: {}, objectives: {}, executions: {}, exec/sec: {},edges_coverage:{},edges_hit:{},edges_count:{}",
            event_msg,
            sender_id.0,
            global_stats.run_time_pretty,
            global_stats.client_stats_count,
